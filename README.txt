...
# Initiates the Docker code for jeth
docker-i1: ## Initiates the Docker code for jeth
	@docker build -f dockerfile.jeth -t jeth .
	@docker run -i -p 50052:50052 --network lab5 --name jeth jeth

# Initiates the Docker code for malkor
docker-i2: ## Initiates the Docker code for malkor
